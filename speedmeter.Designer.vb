...
Partial Class speedmeter
    ...
    Private Sub InitializeComponent()
        ...
        Me.VisualizzaIToolStripMenuItem.Text = "visualizza i :"
        '
        'speedmeter
        '
